...
| Analytics | GET | `/api/analytics/performance` | Admin | Analytics | Performance KPIs (success rate, confidence, saved count) |
| Analytics | GET | `/api/analytics/dashboard` | Admin | (optional) | Consolidated admin analytics payload |
